export default function CalculatorFormInput({
  ...
  return (
    <div className="flex flex-col mt-4 calculator-form-input md:mt-0">
      ...
      <div className="relative mt-2 md:mt-1">
        <input
          className={`
            ...
            focus:outline-none focus:border-dark-blue  h-14 md:h-12  text-dark-blue font-bold py-2 rounded-md border-2 w-full ${formError ? "border-error-red" : "border-almost-light-blue bg-white"}
            `}
